...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.EntityRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.EntityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.ModuleFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.ModuleRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.ModuleUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.Module", b =>
                {
                    b.HasOne("OSharp.Template.Authorization.Entities.Module", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("OSharp.Template.Authorization.Entities.ModuleFunction", b =>
                {
                    ...
                    b.HasOne("OSharp.Template.Authorization.Entities.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("OSharp.Template.Identity.Entities.Organization", b =>
                {
                    b.HasOne("OSharp.Template.Identity.Entities.Organization", null)
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("OSharp.Template.Identity.Entities.Role", b =>
                {
                    b.HasOne("OSharp.Template.Infos.Entities.Message", null)
